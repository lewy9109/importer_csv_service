...
class UploaderTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->uploader = new Uploader($this->uploadDir, $this->fileSystem, $this->messageBus, $this->entityManager);
    }
    ...
    public function testSaveChunk(): void
    {
        ...
        $this->messageBus->expects($this->once())
            ->method("dispatch")
            ->with($this->isInstanceOf(CreatedReportImportFile::class))
            ->willReturn(new Envelope(new CreatedReportImportFile($this->uploadDir . "test.csv")));
